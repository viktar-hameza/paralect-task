interface FavoritesIconProps extends React.SVGProps<SVGSVGElement> {
  isFavorite: boolean;
}

export const FavoritesIcon = ({ isFavorite, ...rest }: FavoritesIconProps) => {
  return (
    <svg
      width="22"
      height="22"
